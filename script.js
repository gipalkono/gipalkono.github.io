document.addEventListener('DOMContentLoaded', function () {
	...
	loginBtn.addEventListener('click', function () {
	  if (loginBtn.textContent === 'Личный кабинет') {
	...
	function displayUserInfo() {
	  ...
	  document.getElementById('user-name').textContent = `Имя пользователя: ${username}`;
  
	  // Пример данных покупок
	  const purchases = [
		'Покупка 1: Ноутбук - 50 000 ₽',
		'Покупка 2: Мышь - 1 500 ₽',
		'Покупка 3: Клавиатура - 3 000 ₽'
	  ];
